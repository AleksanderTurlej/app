 ...
 */
final class Version20200714105327 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE opinion ADD CONSTRAINT FK_AB02B0272F7D140B FOREIGN KEY (medicine_id) REFERENCES medicine (id)');
